...
function colorize(editor) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (uri == null || configuration_1.ignoredLanguages.has(editor.document.languageId)) {
            return;
        }
        ...
        const rangesBySymbolName = (0, rangesByName_1.rangesByName)(tokensData, legend, editor);
